...
API_ID = int(os.environ.get("API_ID", '29810598'))
# API Hash from https://my.telegram.org/auth
API_HASH = os.environ.get("API_HASH", '4f6367a57aeebcf48b58c179684c8250')
BOT_TOKEN = os.environ.get("BOT_TOKEN", '6173762846:AAG0GIofueMkVNzU1iqS79wJO8WMDkKQjyI')  # Bot token from @BotFather
ADMINS = (
    [int(i.strip()) for i in os.environ.get("ADMINS", '5257526759').split(",")]
    if os.environ.get("ADMINS", '5257526759')
    else []
)

DATABASE_NAME = os.environ.get("DATABASE_NAME", "RAJESH")
DATABASE_URL = os.environ.get(
    "DATABASE_URL", 'mongodb+srv://Mdisksite:Mdisk9898@cluster0.26dzid8.mongodb.net/?retryWrites=true&w=majority'
)  # mongodb uri from https://www.mongodb.com/
OWNER_ID = int(os.environ.get("OWNER_ID", '5257526759'))  # id of the owner
ADMINS.append(OWNER_ID) if OWNER_ID not in ADMINS else []

#  Optionnal variables
LOG_CHANNEL = int(
    os.environ.get("LOG_CHANNEL", "-1001923565687")
...
WELCOME_IMAGE = os.environ.get("WELCOME_IMAGE", "https://telegra.ph/file/5a3c97887aabbaa4841af.jpg")
LINK_BYPASS = is_enabled(
    (os.environ.get("LINK_BYPASS", "False")), False
)  # if true, urls will be bypassed
# your shortener site domain
BASE_SITE = os.environ.get("BASE_SITE", "shorturls.site")
